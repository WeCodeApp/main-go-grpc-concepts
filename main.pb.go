...
func (x *UserProfle) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserProfle) ProtoMessage() {}

func (x *UserProfle) ProtoReflect() protoreflect.Message {
	mi := &file_main_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserProfle.ProtoReflect.Descriptor instead.
func (*UserProfle) Descriptor() ([]byte, []int) {
	return file_main_proto_rawDescGZIP(), []int{2}
}

func (x *UserProfle) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *UserProfle) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
var file_main_proto_goTypes = []any{
	...
	(*UserProfle)(nil),    // 2: main.UserProfle
}
