...
const (
	Farewell_BidGoodbye_FullMethodName = "/farewell.Farewell/BidGoodbye"
)
...
func (c *farewellClient) BidGoodbye(ctx context.Context, in *GoodByeRequest, opts ...grpc.CallOption) (*GoodByeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GoodByeResponse)
	err := c.cc.Invoke(ctx, Farewell_BidGoodbye_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedFarewellServer) BidGoodbye(context.Context, *GoodByeRequest) (*GoodByeResponse, error) {
...
func _Farewell_BidGoodbye_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GoodByeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FarewellServer).BidGoodbye(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Farewell_BidGoodbye_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FarewellServer).BidGoodbye(ctx, req.(*GoodByeRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Farewell_BidGoodbye_Handler,
		},
	},
