...
const file_proto_main_proto_rawDesc = "" +
	...
	"\x06number\x18\x01 \x01(\x05R\x06number2\xdf\x01\n" +
	"\tCalculate\x126\n" +
	...
	"\vSendNumbers\x12\x19.calculator.NumberRequest\x1a\x1a.calculator.NumberResponse(\x01B\x13Z\x11/proto/gen;mainpbb\x06proto3"
...
var file_proto_main_proto_goTypes = []any{
	...
	(*AddResponse)(nil),       // 3: calculator.AddResponse
...
var file_proto_main_proto_depIdxs = []int32{
	2, // 0: calculator.Calculate.Add:input_type -> calculator.AddRequest
	4, // 1: calculator.Calculate.GenerateFibonacci:input_type -> calculator.FibonacciRequest
	0, // 2: calculator.Calculate.SendNumbers:input_type -> calculator.NumberRequest
	3, // 3: calculator.Calculate.Add:output_type -> calculator.AddResponse
	5, // 4: calculator.Calculate.GenerateFibonacci:output_type -> calculator.FibonacciResponse
	1, // 5: calculator.Calculate.SendNumbers:output_type -> calculator.NumberResponse
